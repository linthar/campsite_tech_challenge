...
class AvailabilityInvalidDatesControllerTest extends  AbstractRestControllerTest {
    ...
    public void testInvalidFromDate() throws Exception {
        ...
        innerTestRequestDatesError(fromDate, toDate, expectedErrorMessage);
    }
    ...
    public void testInvalidToDate() throws Exception {
        ...
        String expectedErrorMessage = "Invalid parameter toDate '" + toDate + "'. Must be at most one month ahead from now";
        innerTestRequestDatesError(fromDate, toDate, expectedErrorMessage);
    }
    ...
    private void innerTestRequestDatesError(LocalDate fromDate, LocalDate toDate, String expectedErrorMessage) {
